...
public class MaterialMaskedEditText extends TextInputLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mKeepHint = typedArray.getBoolean(R.styleable.MaterialMaskedEditText_keep_mask_hint, true);
        ...
        String mask = typedArray.getString(R.styleable.MaterialMaskedEditText_mask);
        if (mask != null && !mask.isEmpty()) {
            mMask = mask;
        }

        setInputFocusListener(new OnFocusChangeListener() {
            @Override
    ...
    public void setInputFocusListener(OnFocusChangeListener focusListener) {
    ...
    public void setAllowedCharacters(String allowedChars) {
        mEditText.setAllowedChars(allowedChars);
    }

    public String getAllowedChars() {
        return mEditText.getAllowedChars();
    }

    public void setDeniedCharacters(String deniedChars) {
        mEditText.setDeniedChars(deniedChars);
    }

    public String getDeniedChars() {
        return mEditText.getDeniedChars();
    }
